...
public class ElementUtil {
	...
	public WebElement getElement(By locator) {
		...
		if(Boolean.parseBoolean(DriverFact.highlight)) {
	...
	// Create utility for title
		...
		// Create utility for ele present in dom as well as Page also by using webElemnt

		public WebElement waitForEleByUseVisible(int timeOut, By locator) {

			WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(timeOut));
			return wait.until(ExpectedConditions.visibilityOf(getElement(locator)));

		}
		// Perform actions-retriving txt for single element
